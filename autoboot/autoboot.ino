 ...
 *  this version also auto detects an attempt to download a program,
 *  records it and programs the target. It has no UI
...
void error1(int errno,unsigned char detail){
   error(errno);
  //error detail indication filled in here
}
